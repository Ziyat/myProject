...
<div class="row">
    ...
    <div class="col s12 m8 l8">
        ...
        <div class="card-image" style="background: url(<?php echo Home::getImageCategory($alimony['alimony_id'], 'alimony'); ?>); background-size: cover; background-position: center;">
        </div>
        <div class="card-stacked">
          <div class="card-content">
          <a href="">
            <b><?php echo $alimony['name']; ?></b>
          </a>
            <p><?php echo $alimony['birth_day']; ?></p>     
          </div>
          <div class="card-action left-align grey-text text-darken-1">
            создано: <?php echo $alimony['create_at']; ?> 
          </div>
        </div>
     </div>
     <form method="post">
