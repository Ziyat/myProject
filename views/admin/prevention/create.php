<?php $titlePage = 'Добавить новость для дня профилактики'; include ROOT . '/views/admin/layout/header.php'; ?>
...
<div class="row">
    ...
    <div class="col s12 m8 l8">
        <h5>Добавить новость для дня профилактики</h5>
        <br>
        <form method="post" enctype="multipart/form-data">
          <div class="row">
          
          <button class="btn col s12 m12 l12" type="submit" name="submit">Добавить</button>
