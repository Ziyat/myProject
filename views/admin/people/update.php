...
<div class="content">
  <div class="row">
    ...
    <div class="col s12 m8 l8">
      <h5><b class="blue-text text-darken-4"><?php echo $people['name'];?></b></h5>
       <hr>
       <form method="post" enctype="multipart/form-data">
          <button class="btn col s12 m12 l12" type="submit" name="submit">Сохранить</button>
            <div class="input-field col s12 m6 l6">
              <input name="name" id="name" type="text" class="validate" value="<?php echo $people['name']?>">
            ...
            <br>
               <div class="switch">
                 <label>
                   Черновик
                   <input name="publish" <?php echo ($people['publish'] == 1) ? 'checked' : '';?> type="checkbox" value="1">
            ...
            <div class="input-field col s12 m12 l12">
              <input name="birth_day" id="birth_day" type="text" class="validate" value="<?php echo $people['birth_day']?>">
            ...
            <div class="file-field input-field col s12 m6 l6">
                ...
                <img class="responsive-img" src="<?php echo Home::getImageCategory($people['people_id'], 'people'); ?>" alt="">
            </div>
          <button class="btn col s12 m12 l12" type="submit" name="submit">Сохранить</button>
      </form>
    </div>
