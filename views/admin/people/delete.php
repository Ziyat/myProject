...
<div class="row">
    ...
    <div class="col s12 m8 l8">
        ...
        <div class="card-image" style="background: url(<?php echo Home::getImageCategory($people['people_id'], 'people'); ?>); background-size: cover; background-position: center;">
        </div>
        <div class="card-stacked">
          <div class="card-content">
          <a href="">
            <b><?php echo $people['name']; ?></b>
          </a>
            <p><?php echo $people['birth_day']; ?></p>     
          </div>
          <div class="card-action left-align grey-text text-darken-1">
            создано: <?php echo $people['create_at']; ?> 
          </div>
        </div>
     </div>
     <form method="post">
