...
//error message
define(ERROR_NAME, 'Илтимос, Исмингизни киритинг');
...
define(LOGIN, 'Тизимга кириш');
define(ALL_FIELDS, 'Мурожаатни юбориш учун барча майдонларни тўлдириш шарт');
...
define(FATHERNAME, 'Отангиз исми');
define(MOBILEPHONE, 'Мобил телефон рақам');
define(PHONE, 'Домашний номер телефона');
define(YOURSTATEMENTS,'Ваши обращения');
define(PROFILE,'Ваши данные');
define(LOGOUT,'Выход');
define(GUVD,'Тошкент шаҳар Ички ишлар бош бошқармаси');
define(GUVDLOGO,'ИИББ');
define(ONLINERECOURSE, 'Онлайн Мурожаат (Виртуал қабулхона)');
define(OFFICIALSITE, 'Расмий сайти');
define(TEST, 'Сайт тест холатида');
define(SITETITLE, 'ИИББ | Расмий сайти');
define(RESETPASSWORD, 'Сброс пароля');
define(TOSENDALETTER, 'Хабарни жўнатиш');
define(ATTACHFILE, 'Файлни танланг...');
define(TEXTOFTHEAPPEAL, 'Мурожаат матни');
define(INDICATEYOURGENDER, 'Жинсингизни танланг');
define(MALE, 'Эркак');
define(FEMALE, 'Аёл');
define(SEX, 'Жинс');
define(WRITEYOURMESSAGE, 'Мурожаатингизни киритинг');
define(FOREXAMPLE, 'мисол учун');
define(BIRTHDATE, 'Туғилган йил');
define(ADDRESS, 'Манзил');
define(SELECTAREA, 'Тумани танланг');
define(AREA, 'тумани');
define(TYPEAPPEAL, 'Мурожаат тури');
define(SPECIFYTYPEAPPEAL, 'Мурожаат турини танланг');
define(PROPOSAL,'Таклиф');
define(APPEAL,'Шикоят');
define(DECLARATION,'Ариза');
define(SPECIFYTHETYPEOFPERSON,'Maқомингизни танланг');
define(TYPEOFPERSON,'Мақомингиз');
define(INDIVIDUAL,'Жисмоний шахс');
define(ENTITY,'Юридик шахс');
define(APPEAL_NUMBER, 'Мурожаат рақами');
define(APPEAL_SECRET, 'Ҳолатни текшириш коди');
define(APPEAL_CHECK, 'Текширмоқ');
define(MODERATOR, 'Модератор');
define(REMEMBER,'Запомните');
define(CHOOSE_A_TOPIC,'Мазмун');
define(OTHER_ISSUES,'бошқа масалалар');
define(TOPIC_OF_THE_APPEAL,'Мурожаат мазмунини танланг');
define(GET_AN_ANSWER,'Жавобни қай тариқа олмоқчисиз');
define(IN_ELECTRONIC_FORM,'Электрон хабар орқалик');
define(IN_WRITING,'Ёзма кўринишда');
define(CAPTCHA,'Расмдаги ёзувни киритинг');
define(CHECK_THE_STATUS,'Мурожаат ҳолатини текшириш');
define(QUESTIONS,'Савол ва жавоблар');
define(LEADERSHIP,'Раҳбарият');
define(RECEPTION,'Қабул кунлари');
define(DAY_OF_PREVENTION,'Профилактика куни');
define(DOCUMENTATION,'Ҳужжатлар');
define(LANGUAGE,'Тиллар');
define(NEWS,'Янгиликлар');
define(PEOPLE_ARE_WANTED, 'Қидирувдаги шахслар');
define(MORE, 'батафсил...');
define(MISSING, 'Бедарак йўқолганлар');
...
define(SCHEDULE, 'Жадвали');
define(SCHEDULE_RECEPTION, 'Тошкент шаҳар ИИББ раҳбарияти томонидан жисмоний ва юридик шахсларни ҳамда ички ишлар идоралари 
ходимларини қабул қилиш');
define(POSITION, 'Лавозим');
define(FIO, 'ФИШ');
define(PHONE_TABLE, 'Телефон');
define(RECEPTION_DAY, 'Қабул кунлари');
define(RECEPTION_TIME, 'Қабул вақти');
define(ADD_COMMENT, 'Фикрингизни қолдиринг');
define(COMMENT_TEXT, 'Фикрингизни матни');
define(PRINT_TEXT, 'Тошкент шаҳар ИИББ бошлиғининг виртуал қабулхонасига келиб тушган мурожаат');
define(LINK, 'Сайт материалларидан фойдаланганда Тошкент шаҳар ИИББ сифатида кўрсатилиши шарт.');
define(RESULT_SEARCH, 'Қидирув натижаси');
define(TELEGRAM, 'Расмий ахборот канали');
define(COMMENTS, 'Фикрлар');
define(ERROR_LOGIN, 'Бундай логин базада бор!');
define(PDD, 'ЙҲҚ жарималарини онлайн кўриш ва тўлов');
define(PASSPORT, 'Биометрик паспорт ҳолатини текшириш');
define(ALIMONY, 'Оталик меҳри йўқ кимсалар');
define(WANTED, 'Қидирувда ');
define(FRAUD, 'Қидирувдаги фирибгарлар');
